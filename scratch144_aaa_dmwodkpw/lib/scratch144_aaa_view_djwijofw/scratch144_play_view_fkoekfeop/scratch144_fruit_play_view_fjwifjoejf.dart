...
class Scratch144FruitPlayViewFjwifjoejf extends Scratch144StatefulWidgetJmndjv{
  Scratch144AaaPlayListener playListener;
  Scratch144FruitPlayViewFjwifjoejf({
    required this.playListener,
  });
  @override
  State<StatefulWidget> createState() => _Scratch144FruitPlayViewFjwifjoejfState();
}

class _Scratch144FruitPlayViewFjwifjoejfState extends Scratch144Statemubfka<Scratch144FruitPlayViewFjwifjoejf>{
  final Scratch144CardTypeEnumDwidjow type=Scratch144CardTypeEnumDwidjow.fruit;
  ...
  final List<String> _iconList=["fruit3","fruit4","fruit5"];
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Stack(
      children: [
        AspectRatio(
          aspectRatio: 1,
          child: Scratch144LocalImagesWidgetGohzrl(scratch144Nametrrwib: "fruit1", scratch144Widthcpygxw: double.infinity, scratch144Heightvnnnnq: double.infinity,),
        ),
        _playWidget(context),
      ],
    ),
              ...
              child: Stack(
                ...
                children: [
                  Scratch144ScratchCardWidgetPwsltd(
                    ...
                    scratch144_cover_image_vlywop: AssetImage("assets/scratch144bsbzmv/fruit2.webp",),
  ...
  _bottomWidget(BuildContext context)=>SizedBox(
    ...
    child: Stack(
      ...
      children: [
        Scratch144LocalImagesWidgetGohzrl(scratch144Nametrrwib: "fruit6", scratch144Widthcpygxw: double.infinity, scratch144Heightvnnnnq: double.infinity),
        Container(
          width: double.infinity,
          height: 201.h,
          ...
          child: Stack(
            children: [
              Scratch144LocalImagesWidgetGohzrl(scratch144Nametrrwib: "fruit7", scratch144Widthcpygxw: double.infinity, scratch144Heightvnnnnq: double.infinity),
              Row(
                children: [
                  SizedBox(
                    width: 77.w,
