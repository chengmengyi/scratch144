...
class Scratch144Hot77PlayViewFjwifjoejf extends Scratch144StatefulWidgetJmndjv{
  ...
  @override
  State<StatefulWidget> createState() => _Scratch144Hot77PlayViewFjwifjoejfState();
}

class _Scratch144Hot77PlayViewFjwifjoejfState extends Scratch144Statemubfka<Scratch144Hot77PlayViewFjwifjoejf>{
  final Scratch144CardTypeEnumDwidjow type=Scratch144CardTypeEnumDwidjow.hot77;
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: Column(
      children: [
        Scratch144LocalImagesWidgetGohzrl(scratch144Nametrrwib: "hot772", scratch144Widthcpygxw: null, scratch144Heightvnnnnq: 94.h,boxFit: BoxFit.fitHeight,),
        ...
        builder:
          ...
          return AnimatedSlide(
            ...
            child: Scratch144ScratchCardWidgetPwsltd(
              ...
              scratch144_cover_image_vlywop: AssetImage("assets/scratch144bsbzmv/hot771.webp",),
  ...
  _bottomWidget()=>SizedBox(
    ...
    child: Stack(
      ...
      children: [
        Scratch144LocalImagesWidgetGohzrl(scratch144Nametrrwib: "hot773", scratch144Widthcpygxw: double.infinity, scratch144Heightvnnnnq: double.infinity),
        Container(
          width: double.infinity,
          height: 201.h,
  ...
  _initRewardList(){
    ...
    while(rewardList.length<12){
      ...
      if(hot7num==1){
        rewardList.add(Scratch144AaaRewardBeanFeifjoe(icon: "hot774", win: true, rewardNum: Scratch144AaaGameConfigUtilsFjeofjoe.instance.getRewardNum(type),win7Type: 1));
      }
      if(hot7num==2){
        rewardList.add(Scratch144AaaRewardBeanFeifjoe(icon: "hot775", win: true, rewardNum: Scratch144AaaGameConfigUtilsFjeofjoe.instance.getRewardNum(type),win7Type: 2));
      }
      rewardList.add(Scratch144AaaRewardBeanFeifjoe(icon: "${Random().nextInt(99)}", win: false, rewardNum: Scratch144AaaGameConfigUtilsFjeofjoe.instance.getRewardNum(type),));
    }
    setState(() {});
  }
