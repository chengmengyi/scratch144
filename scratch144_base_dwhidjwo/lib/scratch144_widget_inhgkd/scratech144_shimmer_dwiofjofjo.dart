...
class Scratech144ShimmerDwiofjofjo extends StatefulWidget {
  final Widget child;
  ...
  const Scratech144ShimmerDwiofjofjo({
    super.key,
    required this.child,
  ...
  @override
  State<Scratech144ShimmerDwiofjofjo> createState() => _ShimmerState();
}

class _ShimmerState extends State<Scratech144ShimmerDwiofjofjo>
